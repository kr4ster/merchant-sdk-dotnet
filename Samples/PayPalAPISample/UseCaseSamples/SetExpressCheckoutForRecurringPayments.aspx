...
<body>
    ...
    <div id="wrapper">
        <div id="header">
            <h3>
                SetExpressCheckout for creating a billing agreement for recurring payments</h3>
            <div id="apidetails">
                Set the details for express checkout, you can set up billing agreements for reference
                transactions and recurring payments.</div>
        </div>
        <br />
        ...
        <div id="request_form">
            ...
            <br />
            <div class="submit">
                <asp:Button ID="SetExpressCheckoutBtn" Text="RecurringPay" runat="server" PostBackUrl="~/UseCaseSamples/Payments.ashx" />
            </div>
            <br />
