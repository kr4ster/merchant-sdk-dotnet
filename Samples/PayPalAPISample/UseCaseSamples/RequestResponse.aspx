<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RequestResponse.aspx.cs"
    Inherits="PayPalAPISample.UseCaseSamples.RequestResponse" %>
...
<body>
    ...
    <div>
        ...
        <br />
        <asp:Label runat="server" ID="LabelRequest" Text="Request" Font-Bold="true"></asp:Label>
        <br />
        <br />
        <asp:TextBox runat="server" ID="TextBoxRequest" TextMode="MultiLine" Rows="20" Width="95%" />
        <br />
        <br />
        <asp:Label runat="server" ID="LabelResponse" Text="Response" Font-Bold="true"></asp:Label>
        <br />
        <br />
        <asp:TextBox runat="server" ID="TextBoxResponse" TextMode="MultiLine" Rows="20" Width="95%" />
        <br />
        <br />
        <div>
