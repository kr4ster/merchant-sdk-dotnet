<%@ Page Language="C#" AutoEventWireup="true" Codebehind="DoDirectPayment.aspx.cs"
    Inherits="PayPalAPISample.APICalls.DoDirectPayment" %>
    ...
    <div id="wrapper">
        <div id="header">
            <h3>
                DoDirectPayment</h3>
            <div id="apidetails">
                Process a credit card payment.</div>
        </div>
