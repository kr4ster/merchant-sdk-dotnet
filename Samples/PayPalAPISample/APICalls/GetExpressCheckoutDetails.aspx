<%@ Page Language="C#" AutoEventWireup="true" Codebehind="GetExpressCheckoutDetails.aspx.cs"
    Inherits="PayPalAPISample.APICalls.GetExpressCheckoutDetails" %>
...
<body>
    <div id="wrapper">
        <div id="header">
            <h3>
                GetExpressCheckoutDetails</h3>
            <div id="apidetails">
                Obtains information about an Express Checkout transaction. Call this API when the
                buyer returns to your site after reviewing the payment details on the PayPal site.</div>
        </div>
